...
//đồng hồ giảm dần của flashsale
function startCountdown() { 
     const timeDisplay = document.querySelector('.fs-time');
     let hours = parseInt(timeDisplay.children[0].textContent);
     let minutes = parseInt(timeDisplay.children[2].textContent);
     let seconds = parseInt(timeDisplay.children[4].textContent);
     ...
     const countdown = setInterval(function() {
         ...
         timeDisplay.children[0].textContent = hours < 10 ? '0' + hours : hours;
         timeDisplay.children[2].textContent = minutes < 10 ? '0' + minutes : minutes;
         timeDisplay.children[4].textContent = seconds < 10 ? '0' + seconds : seconds;
     }, 1000);
 }
